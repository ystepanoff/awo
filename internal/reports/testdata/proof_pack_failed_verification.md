...
- recommendation: **failed_verification**
...
Recommended next step: verification failed — inspect the verify/ artifacts, fix the failure, and rerun before considering the change.
